    ...
    <>
      <Header />
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <h1 className="text-4xl font-bold text-[#013220]">
            Available Rooms
            </h1>
        ...
        <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-gray-200 shadow-2xl px-5 py-4">
