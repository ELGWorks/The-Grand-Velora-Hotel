  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 px-6">
      <div className="w-full max-w-lg bg-white rounded-3xl shadow-2xl p-8">
        <h2 className="text-2xl font-bold text-[#013220]">Select Guests</h2>
        ...
        <div className="flex items-center justify-between mt-8">
          ...
          <div className="text-center">
            <p className="text-4xl font-bold text-[#013220]">{guests}</p>

            <p className="text-gray-500">{guests === 1 ? "Guest" : "Guests"}</p>
          </div>
